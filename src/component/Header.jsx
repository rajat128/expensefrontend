  ...
  return (
   ...
   <nav className='bg-slate-800 w-full text-white flex justify-between  h-16 px-5 md:px-16 py-5'>
    <div className='flex  justify-between'>
     <h1 className=' font-black text-xl mb-1 hover:text-green-500 font-serif group transition duration-3000 md:transition duration-2000'>Expense Tracker
     <span className='block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-green-400' />
     </h1>
...
<ul className=' hidden flex justify-between  text-white'  ref={ref} >
        <div className='flex justify-between '>
         <li className='mr-4 md:mr-8 lg:mr-12 font-medium hover:text-red-500 group transition duration-3000'>Home
       <span className='block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-red-800' /></li> 
