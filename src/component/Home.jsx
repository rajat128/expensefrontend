...
function Home() {
  ...
  const options = ["Last Week", "Last Month", "Last Year", "Custom"];
  const typeOptions = ["All", "Expense", "Earned"];
  function Clicked() {
    setClick(!click);
  }
      ...
      {!loading ? (
        <div className="h-screen w-screen bg-slate-200 font-karla">
          <div className="flex justify-around pt-16  ">
            <div className="md:w-32 sm">
              <h2 className="mb-2">Select Frequency</h2>
              <select
                className="rounded-md font-karla h-10 max-sm:w-32"
                name="frequency"
                value={frequency}
            ...
            <div className="md:w-32">
              <h2 className="mb-2">Select Type</h2>
              <select
                className="rounded-md font-karla h-10 max-sm:w-32"
                name="type"
                value={type}
          ...
          {loading ? (
            ...
            <Display data={cUser.transactions} user={cUser} />
          )}
        </div>
      ) : (
        <div className="flex justify-center place-items-center  mt-64 ">
